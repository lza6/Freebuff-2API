...
### Desktop (recommended)
Download `Freebuff2API Setup 0.1.0.exe` from Releases → install → launch → gateway auto-starts → dashboard opens. Use tray "Login new account" to auto-capture cookies.
